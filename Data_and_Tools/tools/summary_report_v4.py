...
if __name__ == "__main__":
    ...
    try:
        ...
        print("Couldn't get insert size stats", file=sys.stderr)
    ...
    try:
        ...
        print("{:<32s}{:^20s}".format("Reads/BC (1):", fragment_stats[7]))
        print("{:<32s}{:^20s}".format("Reads/BC (2):", fragment_stats[8]))
        print("{:<32s}{:^20s}".format("Reads/BC (3):", fragment_stats[9]))
        print("{:<32s}{:^20s}".format("Reads/BC (4):", fragment_stats[10]))
        print("{:<32s}{:^20s}".format("Reads/BC (5, 10]:", fragment_stats[11]))
        print("{:<32s}{:^20s}".format("Reads/BC (10, 25]:", fragment_stats[12]))
        print("{:<32s}{:^20s}".format("Reads/BC (25, 50]:", fragment_stats[13]))
        print("{:<32s}{:^20s}".format("Reads/BC (50, 100]:", fragment_stats[14]))
        print("{:<32s}{:^20s}".format("Reads/BC (100+):", fragment_stats[15]))
    except:
        print("Couldnn't get fragment stats", file=sys.stderr)
